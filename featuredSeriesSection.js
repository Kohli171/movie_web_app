...
export default function FeaturedSeriesSection({seeDetail, setMovieId, setMovieData}) {
    //DUMMY DATA
    const [featuredMovies, setFeaturedMovies] = useState();

    function fetchFM() {
        try {
            axios.get(`${apiEndpoint}/movies?Type=series`)
            .then((res)=>{
    ...
    return (
        <div className='featuredMovieSection'>
            <div className='featuredMovieSectionHeader'>
                <div className='featuredMovieSectionTitle'>Featured TV Series</div>
